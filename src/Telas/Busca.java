...
public class Busca extends javax.swing.JFrame {
    ...
    String[] prod2 = new String[6];
    String[] prod3 = new String[6];
    String[] prod4 = new String[6];
    String[] prod5 = new String[6];
    ...
    private void initComponents() {
        ...
        txtBusca.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        lblCesto.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        pnlProd1.add(lblLink1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, -1, -1));
        ...
        pnlProd2.add(lblLink2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, -1, -1));
        ...
        pnlProd3.add(lblLink3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, -1, -1));
        ...
        pnlProd4.add(lblLink4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, -1, -1));
    ...
    private void lblAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAddMouseClicked
        ...
        if (checkProd2.isSelected()) {
            if (prod1[0] == null) {
                ...
                prod4[5] = lblLink2.getText();
            } else if (prod4[0] != null && prod5[0] == null) {
                prod5[0] = lblProd2.getText();
                prod5[1] = lblPreco2.getText();
                prod5[2] = lblMercado2.getText();
                prod5[3] = lblDesconto2.getText();
                prod5[4] = lblDistancia2.getText();
                prod5[5] = lblLink2.getText();
            }
        }
        ...
        if (checkProd3.isSelected()) {
            if (prod1[0] == null) {
                ...
                prod4[5] = lblLink3.getText();
            } else if (prod4[0] != null && prod5[0] == null) {
                prod5[0] = lblProd3.getText();
                prod5[1] = lblPreco3.getText();
                prod5[2] = lblMercado3.getText();
                prod5[3] = lblDesconto3.getText();
                prod5[4] = lblDistancia3.getText();
                prod5[5] = lblLink3.getText();
            }
        }
        ...
        if (checkProd4.isSelected()) {
            if (prod1[0] == null) {
                ...
                prod4[5] = lblLink4.getText();
            } else if (prod4[0] != null && prod5[0] == null) {
                prod5[0] = lblProd4.getText();
                prod5[1] = lblPreco4.getText();
                prod5[2] = lblMercado4.getText();
                prod5[3] = lblDesconto4.getText();
                prod5[4] = lblDistancia4.getText();
                prod5[5] = lblLink4.getText();
            }
        }
        checkProd1.setSelected(false);
        checkProd2.setSelected(false);
    ...
    private void Feijao() {
        ...
        lblProd4.setText(feijao[0]);
        lblPreco4.setText(feijao[10]);
        lblMercado4.setText(feijao[11]);
        lblDistancia4.setText(feijao[12]);
    ...
    private void Monster() {
        ...
        lblProd4.setText(monster[0]);
        lblPreco4.setText(monster[10]);
        lblMercado4.setText(monster[11]);
        lblDistancia4.setText(monster[12]);
    ...
    private void Macarrao() {
        ...
        lblProd4.setText(macarrao[0]);
        lblPreco4.setText(macarrao[10]);
        lblMercado4.setText(macarrao[11]);
        lblDistancia4.setText(macarrao[12]);
    ...
    private void Arroz() {
        ...
        lblProd4.setText(arroz[0]);
        lblPreco4.setText(arroz[10]);
        lblMercado4.setText(arroz[11]);
        lblDistancia4.setText(arroz[12]);
    ...
    private void Chocolate() {
        ...
        lblProd4.setText(bombom[0]);
        lblPreco4.setText(bombom[10]);
        lblMercado4.setText(bombom[11]);
        lblDistancia4.setText(bombom[12]);
